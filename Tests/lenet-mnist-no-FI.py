...
#     saver.save(sess, '/home/elainey/backup/pycharmProjects/yamlTest/Tests/lenet-checkpoint/lenet')
#     print("Model saved")

with tf.Session() as sess:
    # Must use absolute path here
    saver.restore(sess, tf.train.latest_checkpoint('/home/elainey/backup/pycharmProjects/yamlTest/Tests/lenet-checkpoint/'))
