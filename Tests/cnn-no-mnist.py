...
#                   "{:.3f}".format(acc))
#     saver.save(sess, '/home/elainey/backup/pycharmProjects/yamlTest/Tests/cnn-checkpoint/cnn')
...
with tf.Session() as sess:
    ...
    saver.restore(sess, tf.train.latest_checkpoint('/home/elainey/backup/pycharmProjects/yamlTest/Tests/cnn-checkpoint/'))
